...
export class UserService extends BaseService {
  ...
  updateUserRole(userId: number, newRole: string): Observable<UserDto> {
    return this.http.patch<UserDto>(`${this.rootUrl}/${userId}/change-role`, { role: newRole });
    
  }

  updateUserStatus(userId: number, newStatus: boolean): Observable<void> {
    return this.http.patch<void>(`${this.rootUrl}/${userId}/role`, { active: newStatus });
  ...
  changePassword(oldPassword: string, newPassword: string): Observable<any> {
    ...
    return this.http.post(`${this.rootUrl}/api/users/change-password`, payload);
  }
